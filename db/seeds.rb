...
#create 6 cars
  ...
  car.photo.attach(io: file, filename: "peugeot206", content_type: "image/png")
  car.save!
  ...
  car.photo.attach(io: file, filename: "renaultclio", content_type: "image/png")
  car.save!
  ...
  car.photo.attach(io: file, filename: "citroenc3", content_type: "image/png")
  car.save!
  ...
  car.photo.attach(io: file, filename: "ferrari296", content_type: "image/png")
  car.save!
  ...
  car.photo.attach(io: file, filename: "audiA3", content_type: "image/png")
  car.save!
  ...
  car.photo.attach(io: file, filename: "bmws1", content_type: "image/png")
  car.save!
